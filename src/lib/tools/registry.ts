 ...
 * an unhandled throw would break delivery.
 */
...
export class ToolRegistry {
   ...
   * handler, then runs the handler and reports its outcome. An unknown
   * name, a validation failure, and a thrown handler error all resolve to
